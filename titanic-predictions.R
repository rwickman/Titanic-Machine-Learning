...
make_prediction = function(pred.mod, test_data)
{
  ...
  table(predict=pred.rounded, truth=test_data$Survived)
  pred
}
...
test.csv.pca3.sub = train.csv.pca3[test_rows, ]
train.csv.pca3.sub = train.csv.pca3[-test_rows, ]

num_comp = find_best_num_components(train.csv.pca3.sub, test.csv.pca3.sub)
